...
#pragma message ( __ERR__ "Setup float uniform!")
            break;
        case nsfw::UNIFORM::FLO3 :
#pragma message ( __ERR__ "Setup vec3 uniform!")
            break;
        case nsfw::UNIFORM::FLO4 :
#pragma message ( __ERR__ "Setup vec4 uniform!")
            break;
        case nsfw::UNIFORM::MAT4 :
#pragma message ( __ERR__ "Setup mat4 uniform!")
            break;
        case nsfw::UNIFORM::INT1 :
#pragma message ( __ERR__ "Setup integer uniform!")
            break;
        case nsfw::UNIFORM::TEX2 :
#pragma message ( __ERR__ "Setup texture2D uniform!")
            break;
        default :
#pragma message ( __ERR__ "INVALID Uniform type.")
            break;
    }
...
#pragma message ( __ERR__ "OVERRIDE: Setup the state of the card for this pass.")
}

// reset the GL state- undo what we did just in case.
void nsfw::RenderPass::post() {
#pragma message ( __ERR__ "OVERRIDE: Clean up the state of the card.")
}
